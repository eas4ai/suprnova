...
## Realized by
- f7ca27ca  live: the checker checks every element a view renders, a declared debounce is one the grammar lists, and error feedback may target an action (LIVE-025 to LIVE-027)
