  ...
  <div class="max-w-md w-full space-y-8">
    <div>
      ...
      <p class="mt-2 text-center text-sm text-gray-600">
        We sent a verification link to <strong>{email}</strong>. Open it while signed in to
        this account.
      </p>
    </div>

    {#if sent}
      <p role="status" class="text-center text-sm text-green-700">A new link has been sent.</p>
    {/if}

    <form class="mt-8 space-y-6" onsubmit={resend}>
      <div>
        <button
          type="submit"
