...
const externalModuleIntegrity = "sha256-As+D2Vb70iDXplo/4qBSHr1HJy/VHD7oX49Az6pqsNE=";
const externalClassicBootIntegrity = "sha256-driX1AsbsALchFYpBEj6JN/QRgsB3x5rHdMifbdcfOA=";
const externalClassicRuntimeIntegrity = "sha256-+os5GMzqRswcp0P6RbvjW2t5wdokUGbWEm3QucMoPs8=";
...
function externalModuleScript(variant = "plain") {
  ...
  if (variant === "integrity") {
    ...
    return '<script type="module" src="/test-boot/module.js" integrity="sha256-As+D2Vb70iDXplo/4qBSHr1HJy/VHD7oX49Az6pqsNE=" crossorigin="anonymous"></script>';
  }
...
function hashOnlyClassicDocument() {
  ...
  return document(
    island(),
    '<script src="/assets/suprnova-live.classic.js" integrity="sha256-+os5GMzqRswcp0P6RbvjW2t5wdokUGbWEm3QucMoPs8=" crossorigin="anonymous"></script><script src="/test-boot/classic.js" integrity="sha256-driX1AsbsALchFYpBEj6JN/QRgsB3x5rHdMifbdcfOA=" crossorigin="anonymous"></script>',
  );
}
