...
- 2026-09-01 -- Benchmark and artifact budgets became on-demand tools outside
  ...
  qualification is release-checklist work outside Iteration 005, and the
  artifact size history behind the historical-baseline question was deleted
  with the artifact budget script, so the release blockers named in the
  2026-08-31 entry no longer apply.
