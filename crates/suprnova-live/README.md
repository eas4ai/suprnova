...
The ordinary gate is not release qualification. Dedicated S1 and B1
qualification of the `U4/16`, `E100/1K`, and `R100` workloads is
release-checklist work outside Iteration 005 and runs through the on-demand
budget tools.
