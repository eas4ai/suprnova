//! PostgreSQL migration entry point.
...
/// Add guarded token and ceremony lookup indexes on PostgreSQL.
///
/// PostgreSQL supports transactional DDL, but this helper deliberately emits
/// additive indexes only; table ownership remains with the application.
