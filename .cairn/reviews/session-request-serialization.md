...
examined:
  ...
  - Re-examined at `15b3663a`: the repository gate found four more dogfood harnesses without a cache store (`05a4596d`, the same fix as the three above; the whole app suite passes with fail-fast off, and the gate stamped `05a4596d` green); the dogfood mechanisms' receipts were refreshed at `15b3663a`.
