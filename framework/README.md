...
```toml
[dependencies]
suprnova = { git = "https://github.com/entrepeneur4lyf/suprnova.git", tag = "v1.1.0" }
...
```toml
[dependencies]
suprnova = { git = "https://github.com/entrepeneur4lyf/suprnova.git", tag = "v1.1.0", default-features = false, features = [
    "database-sqlite",
    "database-postgres",
    "broadcasting-fanout",
] }
...
```bash
cargo install --git https://github.com/entrepeneur4lyf/suprnova.git --tag v1.1.0 suprnova-cli
suprnova new myapp
```
