...
- **Rust 1.94.0+** pour la branche `main` actuelle (le workspace utilise l’édition 2024). La version étiquetée v2.0.2 exige également Rust 1.94.0 au minimum. Installez-le via [rustup](https://rustup.rs/) :
  ```bash
...
`tag = "v2.0.2"`, et `Cargo.lock` enregistre le commit exact que cette
