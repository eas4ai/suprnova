...
- Authentification (sessions, hachage de mot de passe, vérification d'e-mail et réinitialisation de mot de passe avec fournisseur, plus 2FA et OAuth via torii)
...
| Sessions | propriétaires (basées sur drivers) |
