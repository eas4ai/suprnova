...
suprnova-payments-stripe = { git = "https://github.com/eas4ai/suprnova.git", tag = "v1.3.5" }
```
...
```toml
# Cargo.toml
suprnova-payments-paddle = { git = "https://github.com/eas4ai/suprnova.git", tag = "v1.3.5" }
```
