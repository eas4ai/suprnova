...
suprnova-payments-stripe = { git = "https://github.com/eas4ai/suprnova.git", tag = "v2.0.2" }
```
...
```toml
# Cargo.toml
suprnova-payments-paddle = { git = "https://github.com/eas4ai/suprnova.git", tag = "v2.0.2" }
```
