...
suprnova-payments-stripe = { git = "https://github.com/entrepeneur4lyf/suprnova.git", tag = "v0.7.1" }
```
...
```toml
# Cargo.toml
suprnova-payments-paddle = { git = "https://github.com/entrepeneur4lyf/suprnova.git", tag = "v0.7.1" }
```
