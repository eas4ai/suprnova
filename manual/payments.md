...
suprnova-payments-stripe = { git = "https://github.com/entrepeneur4lyf/suprnova.git", tag = "v1.0.0" }
```
...
```toml
# Cargo.toml
suprnova-payments-paddle = { git = "https://github.com/entrepeneur4lyf/suprnova.git", tag = "v1.0.0" }
```
