...
suprnova-payments-stripe = { git = "https://github.com/eas4ai/suprnova.git", tag = "v1.3.6" }
```
...
```toml
# Cargo.toml
suprnova-payments-paddle = { git = "https://github.com/eas4ai/suprnova.git", tag = "v1.3.6" }
```
