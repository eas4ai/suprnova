...
- **Rust 1.94.0+** para a `main` atual (o workspace usa a edição 2024). A versão v1.2.4 marcada mantém Rust 1.91.1 como versão mínima. Instale por meio do [rustup](https://rustup.rs/):
  ```bash
