...
| **Auth** | Framework guards, middleware, providers, and browser sessions; Magnetar-backed password, passkey, magic-link, OAuth, bearer-session, lockout, remember, auth-epoch, and migration engines; provider-backed email verification; framework TOTP compatibility facade; policy macros and gates |
