...
| `suprnova ssr:check [--url <url>] [--timeout-ms N]` | Prüft, ob die Route `GET /health` des SSR-Workers mit 2xx antwortet. Fällt auf `SUPRNOVA_SSR_URL` und danach auf `http://127.0.0.1:13714` zurück. Standard-Timeout: 2000 ms. |
