...
- **Rust 1.94.0+** für den aktuellen `main`-Branch (der Workspace verwendet die Edition 2024). Das getaggte Release v1.3.6 hat dieselbe Mindestversion Rust 1.94.0. Installation über [rustup](https://rustup.rs/):
  ```bash
...
`tag = "v1.3.6"`, und `Cargo.lock` verzeichnet den exakten Commit, auf den
