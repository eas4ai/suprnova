...
- **Rust 1.94.0+** für den aktuellen `main`-Branch (der Workspace verwendet die Edition 2024). Das getaggte Release v2.1.0 hat dieselbe Mindestversion Rust 1.94.0. Installation über [rustup](https://rustup.rs/):
  ```bash
...
`tag = "v2.1.0"`, und `Cargo.lock` verzeichnet den exakten Commit, auf den
