...
prozessübergreifende Koordination innerhalb derselben Minute brauchen, schichten Sie `without_overlapping` + ein konfiguriertes Cache-Backend - zusammen decken sie beide Richtungen ab.
